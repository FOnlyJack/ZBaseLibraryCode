...
public class ZBaseGridLayoutManager extends GridLayoutManager implements RecyclerViewScrollManager.OnScrollManagerLocation {
    private static final String TAG = ZBaseGridLayoutManager.class.getSimpleName();
    ...
    public ZBaseGridLayoutManager(Context context, int spanCount) {
        super(context, spanCount);
    }

    public ZBaseGridLayoutManager(Context context, int spanCount, int orientation, boolean reverseLayout) {

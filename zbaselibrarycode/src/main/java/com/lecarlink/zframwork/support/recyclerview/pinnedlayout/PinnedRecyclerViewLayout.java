package com.lecarlink.zframwork.support.recyclerview.pinnedlayout;
...
import com.lecarlink.zframwork.support.recyclerview.layoutmanager.ZBaseLinearLayoutManager;
import com.lecarlink.zframwork.support.recyclerview.listener.OnRecyclerViewScrollListener;
...
public class PinnedRecyclerViewLayout extends RelativeLayout {
    ...
    private ZBaseLinearLayoutManager layoutManager;

    public void initRecyclerPinned(RecyclerView recyclerView, ZBaseLinearLayoutManager layoutManager, View pinnedView) {

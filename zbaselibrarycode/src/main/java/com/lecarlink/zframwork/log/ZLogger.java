...
import com.lecarlink.zframwork.utils.ZTimeUtil;
            ...
            public Void runInBackground() {
                synchronized (ZLogger.class) {
                    ...
                    String filename = logFilePath
                            + ZTimeUtil.millisToStringFilename(System.currentTimeMillis(), "yyyy-MM-dd")
                            + ".log";
                    ...
                    try {
                        ...
                        String formatMsg = ZTimeUtil.millisToStringDate(System.currentTimeMillis()) + "\r\n[" + priority + "][" + tag + "]: \r\n"
                                + "User Message: " + msg + "\r\n"
                                + (null == tr ? "" :

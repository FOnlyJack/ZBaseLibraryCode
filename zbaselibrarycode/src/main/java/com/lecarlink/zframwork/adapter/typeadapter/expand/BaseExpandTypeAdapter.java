package com.lecarlink.zframwork.adapter.typeadapter.expand;
...
import com.lecarlink.zframwork.adapter.ZBaseExpandableListAdapter;

/**
 * 不同ExpandableListView   type的 adapter
 */
public abstract class BaseExpandTypeAdapter extends ZBaseExpandableListAdapter {

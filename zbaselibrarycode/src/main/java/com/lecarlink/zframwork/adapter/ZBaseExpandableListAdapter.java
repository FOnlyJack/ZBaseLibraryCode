...
/**
 * 普通类型ExpandableListView的adapter封装
 */
public abstract class ZBaseExpandableListAdapter extends BaseExpandableListAdapter implements AbsListView.OnScrollListener {
    private static final String TAG = ZBaseExpandableListAdapter.class.getSimpleName();
    ...
    protected ZBaseExpandableListAdapter(ExpandableListView listView) {

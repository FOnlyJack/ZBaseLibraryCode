package com.lecarlink.zframwork.app;
...
import com.lecarlink.zframwork.utils.ZEmulator;
...
public final class ZAppEnv {

	/***Log输出标识**/
	private static final String TAG = ZAppEnv.class.getSimpleName();
	
	/***屏幕显示材质**/
	private static final DisplayMetrics mDisplayMetrics = new DisplayMetrics();
	
	/**上下文**/
	private static final Context context = ZBaseApplication.getInstance();
